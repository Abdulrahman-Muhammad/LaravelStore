    ...
    <div class="page-wrapper">
        <div class="authentication-box">
          ...
          137.239,360.959 160.785,398.8 188.393,349.552 195.722,353.66 161.162,415.307 137.661,377.538 108.064,430.978 	" />
                                        <rect x="26" y="357.765" style="fill:#999999;" width="27"
                                            height="11" />
                                        <rect x="26" y="384.765" style="fill:#999999;" width="27"
                                            height="11" />
                                        <rect x="26" y="411.765" style="fill:#999999;" width="27"
                                            height="11" />
                                        <polyline style="fill:#6EC6EB;"
                                            ...
                                            <div class="form-terms">
                                                <div class="form-check mesm-2">
                                                    ...
                                                    <a href="javascript:void(0)"
                                                        class="btn btn-default forgot-pass">Forgot
                                                        Password!</a>
                                                </div>
                                            </div>
